...
server.use(function(request, response, next) {
    response.header("Access-Control-Allow-Origin", "http://localhost:10013");
...
mongoose.connect(`mongodb://${process.env.DBUSER}:${process.env.DBPASS}@mongection_db:27013/mongection`, {useNewUrlParser: true})
    .then( () => {
